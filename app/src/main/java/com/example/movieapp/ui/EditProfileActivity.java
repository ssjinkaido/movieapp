...
public class EditProfileActivity extends AppCompatActivity {
    ...
    private void updateProfile() {
        ...
        FirebaseDatabase.getInstance().getReference().child("Users").child(Util.getUserUid()).updateChildren(map);
    ...
    private void uploadImage() {
        ...
        if (mImageUri != null) {
            final StorageReference fileRef = storageRef.child(Util.getUserUid() + ".jpeg");
            ...
            uploadTask.continueWithTask(new Continuation() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("Users").child(Util.getUserUid()).child("image").setValue(url);
                        pd.dismiss();
                    } else {
